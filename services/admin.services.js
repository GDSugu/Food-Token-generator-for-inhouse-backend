...
const {findAll,findById,insert,updateById,deleteById,findadmin} = require("../helpers/admin.helpers")
...
module.exports = {
    ...
    async create(req,res){
        ...
        try {
                    ...
                    if(!admin.post) return res.status(401).json({ message: "Unauthorised user" });
